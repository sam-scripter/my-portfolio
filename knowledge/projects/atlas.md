...
## Lessons Learned
The scoring rubric required calibration. Initial runs produced too many scores in the 6-7 range because the model was being generous. Tightening the context to include explicit criteria ("a score of 8 requires: Flutter as a primary requirement, Python or AI in the stack, remote-friendly, mid-level experience range") improved score distribution significantly. Prompt precision matters as much as prompt completeness.