...
The Accessibility Service only activates when the user explicitly triggers the overlay. It does not run continuously in the background reading all screen content passively. The user taps the floating button to activate reading, a deliberate privacy design choice.
